...
async function ideaForActivity(weather, participants, city, date) {
  ...
  const promptOfActivity = `Give me an original idea for an activity for ${participants} in ${city} on ${date} according to the weather conditions, show the weather in degrees. (up to eight sentences).`;
